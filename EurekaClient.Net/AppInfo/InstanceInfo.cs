...
namespace EurekaClient.Net.AppInfo
{
    public class InstanceInfo
    {
        ...
        public static InstanceInfo FromInstanceConfig(IEurekaInstanceConfig instanceConfig)
        {
            ...
            {
                info.InstanceId = instanceConfig.GetHostName(true) + ":" + instanceConfig.AppName + ":" + instanceConfig.NonSecurePort;
            }
        ...
        public static InstanceInfo FromJsonInstance(JsonInstanceInfo json)
        {
            InstanceInfo info = new InstanceInfo();
            if (json != null)
            {
