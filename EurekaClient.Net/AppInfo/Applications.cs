...
namespace EurekaClient.Net.AppInfo
{
    public class Applications
    {
        ...
        public Applications(IList<Application> apps)
        {
            if (apps == null)
            {
        ...
        public void AddInstances(Application app)
        {
        ...
        public void AddInstanceToVip(InstanceInfo inst)
        {
        ...
        public void AddInstanceToVip(string address, InstanceInfo info, ConcurrentDictionary<string, ConcurrentDictionary<string, InstanceInfo>> dict)
        {
        ...
        public void RemoveInstanceFromVip(InstanceInfo inst)
        {
            if (!string.IsNullOrEmpty(inst.VipAddress))
            {
        ...
        public void RemoveInstanceFromVip(string address, InstanceInfo info, ConcurrentDictionary<string, ConcurrentDictionary<string, InstanceInfo>> dict)
        {
            lock (_addRemoveInstanceLock)
            {
                string addressUppper = address.ToUpperInvariant();
        ...
        public void UpdateFromDelta(Applications delta)
        {
        ...
        public ConcurrentDictionary<string, Application> ApplicationMap
        {
            get
            {
        ...
        public ConcurrentDictionary<string, ConcurrentDictionary<string, InstanceInfo>> VirtualHostInstanceMap
        {
            get
            {
        ...
        public ConcurrentDictionary<string, ConcurrentDictionary<string, InstanceInfo>> SecureVirtualHostInstanceMap
        {
            get
            {
        ...
        public static Applications FromJsonApplications(JsonApplications japps)
        {
